...
//fun String.isVideoFast() = com.hoicham.orc.core.utils.getVideoExtensions.any { endsWith(it, true) }
//
//fun String.isImageFast() = com.hoicham.orc.core.utils.getPhotoExtensions.any { endsWith(it, true) }
//fun String.isAudioFast() = com.hoicham.orc.core.utils.getAudioExtensions.any { endsWith(it, true) }
//fun String.isRawFast() = com.hoicham.orc.core.utils.getRawExtensions.any { endsWith(it, true) }
//
...
fun String.getCompressionFormat() = when (getFilenameExtension().lowercase(Locale.ROOT)) {
